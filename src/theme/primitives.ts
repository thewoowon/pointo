// AUTO-GENERATED from `primitive colors.json` (Figma: Primitive Colors)
// Do not edit by hand — regenerate from the Figma variable export.
...
export const primitives = {
  ...
  blue: { 50: '#EFF6FF', 100: '#D9E9FF', 200: '#BCD9FF', 300: '#8EC2FF', 400: '#599FFF', 500: '#2974FF', 600: '#1B59F5', 700: '#1444E1', 800: '#1737B6', 900: '#19348F' },
